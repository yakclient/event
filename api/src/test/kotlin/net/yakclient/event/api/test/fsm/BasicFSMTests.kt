package net.yakclient.event.api.test.fsm
...
import net.yakclient.event.api.test.KeyboardActionData
import net.yakclient.event.api.test.MouseActionData
import net.yakclient.event.api.test.MouseMoveData
import net.yakclient.event.api.test.TestEventOne
